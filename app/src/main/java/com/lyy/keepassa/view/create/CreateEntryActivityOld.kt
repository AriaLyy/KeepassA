 ...
 * 创建或编辑条目
 */
@Route(path = "/entry/createold")
class CreateEntryActivityOld : BaseActivity<ActivityEntryEditBinding>() {
  ...
  companion object {
    ...
    internal fun authAndSaveDb(
      ...
      val intent = Intent(context, CreateEntryActivityOld::class.java).also {
        ...
        btnClickListener = object : OnMsgBtClickListener {
          override fun onEnter(v: Button) {
            searchLauncher.launch(
              it,
              ActivityOptionsCompat.makeSceneTransitionAnimation(this@CreateEntryActivityOld)
            )
          }
    ...
    binding.titleLayout.setEndIconOnClickListener {
      ...
      iconDialog.setCallback(object : IconItemCallback {
        ...
        override fun onCustomIcon(customIcon: PwIconCustom) {
          ...
          binding.titleLayout.endIconDrawable =
            IconUtil.convertCustomIcon2Drawable(this@CreateEntryActivityOld, module.customIcon!!)
        }
      })
    ...
    if (binding.attrStrLayout.visibility == View.GONE) {
      ...
      binding.attrStrs.setOnStrViewClickListener(object :
        ...
        override fun onClickListener(
          ...
          val menu = EntryCreateStrPopMenu(this@CreateEntryActivityOld, v, key, str)
          menu.show()
        }
      })
    }
    ...
    if (binding.attrFileLayout.visibility == View.GONE) {
      ...
      binding.attrFiles.setOnAttrFileViewClickListener(object :
        ...
        override fun onClickListener(
          ...
          val menu = EntryCreateFilePopMenu(this@CreateEntryActivityOld, v, key)
          menu.show()
        }
      })
    }
