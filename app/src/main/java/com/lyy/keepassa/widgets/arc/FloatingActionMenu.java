 ...
 */
package com.lyy.keepassa.widgets.arc;
...
import com.lyy.keepassa.widgets.arc.animation.DefaultAnimationHandler;
import com.lyy.keepassa.widgets.arc.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
  ...
  private CenterPointInterceptor pointInterceptor;
  ...
  public FloatingActionMenu(final View mainActionView,
      ...
      CenterPointInterceptor pointInterceptor
      ) {
    ...
    if (animated && animationHandler != null) {
      ...
      for (int i = 0; i < subActionItems.size(); i++) {
        ...
        final FrameLayout.LayoutParams params =
            new FrameLayout.LayoutParams(subActionItems.get(i).width, subActionItems.get(i).height,
   ...
   * Toggles the menu
   *
   * @param animated if true, the open/close action is executed by the current
  ...
  private Point getActionViewCoordinates() {
    ...
    if (systemOverlay) {
      ...
      coords[1] -= (activityFrame.height() + activityFrame.top
          - getActivityContentView().getMeasuredHeight());
    }
  ...
  public Point getActionViewCenter() {
    if (pointInterceptor != null){
      return pointInterceptor.getActionViewCenter(mainActionView);
    }
  ...
  public View getActivityContentView() {
    try {
      return getActivityFromView(mainActionView).getWindow()
          .getDecorView()
  ...
  public int getStatusBarHeight() {
    int result = 0;
    int resourceId = mainActionView.getContext()
        .getResources()
  ...
  public interface CenterPointInterceptor{
    public Point getActionViewCenter(View mainActionView);
  }
  ...
  public static class Builder {
    ...
    public Builder setPointInterceptor(CenterPointInterceptor pointInterceptor){
      this.pointInterceptor = pointInterceptor;
      return this;
    }
