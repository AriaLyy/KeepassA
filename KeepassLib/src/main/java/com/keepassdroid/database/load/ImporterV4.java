...
public class ImporterV4 extends Importer {
  ...
  public PwDatabaseV4 openDatabase(InputStream inStream, String password,
    ...
    return openDatabase(inStream, password, keyInputStream, 0);
  }
  ...
  public PwDatabaseV4 openDatabase(InputStream inStream, String password,
    ...
    randomStream =
        PwStreamCipherFactory.getInstance(header.innerRandomStream, header.innerRandomStreamKey);

    if (randomStream == null) {
      throw new ArcFourException();
    }
    //BufferedReader reader = new BufferedReader(new InputStreamReader(isXml));
    //String line = "";
  ...
  private KdbContext EndXmlElement(KdbContext ctx, XmlPullParser xpp)
    ...
    if (ctx == KdbContext.KeePassFile && name.equalsIgnoreCase(ElemDocNode)) {
      ...
      return KdbContext.Group;
    } else if (ctx == KdbContext.GroupCustomDataItem && name.equalsIgnoreCase(
        ElemStringDictExItem)) {
      ...
      return KdbContext.Entry;
    } else if (ctx == KdbContext.EntryCustomDataItem && name.equalsIgnoreCase(
        ElemStringDictExItem)) {
      ...
      throw new RuntimeException(
          "Invalid end element: Context " + contextName + "End element: " + name);
    }
  }
  ...
  private boolean ReadBool(XmlPullParser xpp, boolean bDefault)
  ...
  private long ReadUInt(XmlPullParser xpp, long uDefault)
      throws IOException, XmlPullParserException {
    long u;
  ...
  private long ReadULong(XmlPullParser xpp, long uDefault)
      throws IOException, XmlPullParserException {
  ...
  private ProtectedString ReadProtectedString(XmlPullParser xpp)
