...
public class PwDbV3Output extends PwDbOutput {
  ...
  public void output() throws PwDbOutputException {
    ...
    try {
      cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(finalKey, "AES"),
          new IvParameterSpec(header.encryptionIV));
  ...
  private void writeExtDataField(LEDataOutputStream los, int fieldType, byte[] data, int fieldSize)
      throws IOException {
