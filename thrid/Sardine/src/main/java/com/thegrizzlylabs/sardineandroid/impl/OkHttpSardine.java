...
public class OkHttpSardine implements Sardine {
  ...
  public void setCredentials(String username, String password, boolean isPreemptive) {
    ...
    final com.burgstaller.okhttp.basic.BasicAuthenticator basicAuthenticator =
        new com.burgstaller.okhttp.basic.BasicAuthenticator(credentials);
  ...
  //            Credentials.basic(userName, password, SardineUtil.standardUTF8()))
  //        .build();
  ...
  @Override
  public List<DavResource> list(String url, int depth, java.util.Set<QName> props)
      throws IOException {
  ...
  @Override
  public List<DavResource> propfind(String url, int depth, java.util.Set<QName> props)
      throws IOException {
    Propfind body = new Propfind();
    Prop prop = new Prop();
    addCustomProperties(prop, props);
  ...
  protected List<DavResource> propfind(String url, int depth, Propfind body) throws IOException {
    RequestBody requestBody =
        RequestBody.create(MediaType.parse("text/xml"), SardineUtil.toXml(body));
  ...
  @Override
  public void move(String sourceUrl, String destinationUrl, boolean overwrite, String lockToken)
      throws IOException {
  ...
  private void addLockTokenToHeaders(Headers.Builder headersBuilder, String destinationUrl,
      String lockToken) {
