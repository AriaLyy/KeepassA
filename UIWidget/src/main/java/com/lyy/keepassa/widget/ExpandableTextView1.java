...
public class ExpandableTextView1 extends LinearLayout implements View.OnClickListener {
  ...
  private void init(AttributeSet attrs) {
    LayoutInflater.from(getContext()).inflate(R.layout.layout_expandable_textview, this, true);

    TypedArray typedArray =
        getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableTextView1);
    mMaxCollapsedLines =
        typedArray.getInt(R.styleable.ExpandableTextView1_maxCollapsedLines, MAX_COLLAPSED_LINES);
    mAnimationDuration =
        typedArray.getInt(R.styleable.ExpandableTextView1_animDuration, DEFAULT_ANIM_DURATION);
    mAnimAlphaStart = typedArray.getFloat(R.styleable.ExpandableTextView1_animAlphaStart,
        DEFAULT_ANIM_ALPHA_START);
    mExpandToggleOnTextClick =
        typedArray.getBoolean(R.styleable.ExpandableTextView1_expandToggleOnTextClick, true);
  ...
  private static ExpandIndicatorController setupExpandToggleController(@NonNull Context context,
      TypedArray typedArray) {
    final int expandToggleType =
        typedArray.getInt(R.styleable.ExpandableTextView1_expandToggleType, DEFAULT_TOGGLE_TYPE);
    ...
    switch (expandToggleType) {
      case EXPAND_INDICATOR_IMAGE_BUTTON:
        Drawable expandDrawable =
            typedArray.getDrawable(R.styleable.ExpandableTextView1_expandIndicator);
        Drawable collapseDrawable =
            typedArray.getDrawable(R.styleable.ExpandableTextView1_collapseIndicator);

        if (expandDrawable == null) {
          expandDrawable = getDrawable(context, R.drawable.ic_arrow_up);
        }
        if (collapseDrawable == null) {
          collapseDrawable = getDrawable(context, R.drawable.ic_arrow_down);
        }
      ...
      case EXPAND_INDICATOR_TEXT_VIEW:
        ...
        String collapseText =
            typedArray.getString(R.styleable.ExpandableTextView1_collapseIndicator);
